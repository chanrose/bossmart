...
class ProductTestCase(TestCase):
    ...
    def setUp(self):
        category = AbstractProductCategory.objects.create(name='small-umbrella').save()  
        product = AbstractProduct.objects.create(name='zag_umbrella', upc='UMB', categories=category).save()
        print(product.name)
